...
class CarbonFootprintCalculator(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.tab8_layout = QVBoxLayout(self.tab8)
        self.feedback_label = QLabel("")
        self.feedback_label.setWordWrap(True)
        self.tab8_layout.addWidget(self.feedback_label)
        
        self.tab8_previous_button = QPushButton("Previous")
        self.tab8_previous_button.clicked.connect(lambda: self.switchTab(6))
        self.tab8_layout.addWidget(self.tab8gb)
        self.tab8_layout.addWidget(self.tab8_previous_button)
